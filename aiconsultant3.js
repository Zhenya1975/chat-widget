...
(function() {
    ...
    class AutoBotChatInline {
        ...
        async sendMessage() {
            ...
            try {
                // console.log('📤 Sending message with session_id:', this.sessionId); // Debug log
                ...
                // console.log('📥 Received response with session_id:', data.session_id); // Debug log
    ...
    function initializeChat() {
        ...
        if (container) {
            new AutoBotChatInline({
                apiUrl: 'https://skynetdev.online/aiconsultant/api/gigachat/send-message/',
                clearUrl: 'https://skynetdev.online/aiconsultant/api/gigachat/clear-context/',
